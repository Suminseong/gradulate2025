...
질문생성기 -> GPT 4o mini로 작업했고, playground에 엔지니어링 끝내고 업로드 완료
퍼소나 생성기 -> 아직 초안. 성격 컨텍스트나 몇몇 가지 변수들 형식 통일. 특히 나이 숫자만 나오게//

GPT 4o mini가 제일 싸니까 이걸로 하고, 대화 AI는 파인튜닝 한 번 더 해봐야...
